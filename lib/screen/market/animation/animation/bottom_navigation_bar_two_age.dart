...
class BottomNavigationBarTwoPage extends StatefulWidget {
  @override
  _BottomNavigationBarTwoPageState createState() =>
      _BottomNavigationBarTwoPageState();
}

class _BottomNavigationBarTwoPageState
    extends State<BottomNavigationBarTwoPage> with TickerProviderStateMixin {
  int currentValue = 0;
