...
class BottomNavigationBarThreePage extends StatefulWidget {
  const BottomNavigationBarThreePage({super.key});

  @override
  _BottomNavigationBarThreePageState createState() =>
      _BottomNavigationBarThreePageState();
}

class _BottomNavigationBarThreePageState
    extends State<BottomNavigationBarThreePage> {
  int currentValue = 0;
