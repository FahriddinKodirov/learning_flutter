...
class PageAnimatedPage extends StatefulWidget {
  const PageAnimatedPage({super.key});

  @override
  _PageAnimatedPageState createState() => new _PageAnimatedPageState();
}

class _PageAnimatedPageState extends State<PageAnimatedPage> {
  double _page = 10;
