...
class AnimationCirculrPage extends StatefulWidget {
  const AnimationCirculrPage({super.key});

  @override
  _AnimationCirculrPageState createState() => _AnimationCirculrPageState();
}

class _AnimationCirculrPageState extends State<AnimationCirculrPage>
