...
class SplashAnimationSecondPage extends StatefulWidget {
  const SplashAnimationSecondPage({super.key});

  @override
  _SplashAnimationSecondPageState createState() => _SplashAnimationSecondPageState();
}

class _SplashAnimationSecondPageState extends State<SplashAnimationSecondPage> {
  @override
