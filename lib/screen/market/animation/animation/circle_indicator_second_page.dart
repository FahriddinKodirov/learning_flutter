...
class CircleIndicatorSecondPage extends StatefulWidget {
  const CircleIndicatorSecondPage({super.key});

  @override
  _CircleIndicatorSecondPageState createState() => _CircleIndicatorSecondPageState();
}

class _CircleIndicatorSecondPageState extends State<CircleIndicatorSecondPage>
