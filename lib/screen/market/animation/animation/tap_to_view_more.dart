...
class TapToViewMore extends StatefulWidget {
  const TapToViewMore({super.key});

  @override
  _TapToViewMoreState createState() => _TapToViewMoreState();
}

class _TapToViewMoreState extends State<TapToViewMore> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:const [
               ...
               Text(
                'Widgets that have global keys reparent their subtrees when they are moved from one location in the tree to another location in the tree. In order to reparent its subtree, a wid',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
