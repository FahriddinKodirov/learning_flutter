...
class HomeScreenThirdPage extends StatefulWidget {
  const HomeScreenThirdPage({super.key});

  @override
  _HomeScreenThirdPageState createState() => _HomeScreenThirdPageState();
}

class _HomeScreenThirdPageState extends State<HomeScreenThirdPage>
...
class RouteWhereYouGo2 extends StatelessWidget {
  const RouteWhereYouGo2({super.key});
