...
class AnimationSecondPage extends StatefulWidget {
  const AnimationSecondPage({super.key});

  @override
  _AnimationSecondPageState createState() => _AnimationSecondPageState();
}

class _AnimationSecondPageState extends State<AnimationSecondPage>
